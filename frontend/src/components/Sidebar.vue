<template>
  <aside class="w-64 bg-slate-900 border-r border-slate-800 flex flex-col">
    <div class="p-5 border-b border-slate-800">
      <h1 class="text-lg font-bold text-cyan-400 tracking-wide">
        SOC Dashboard
      </h1>
      <p class="text-xs text-slate-500 mt-1">Alert Triage & Response</p>
    </div>
    <nav class="flex-1 p-3 space-y-1">
      <router-link
        ...
        :class="
          $route.path === item.to || $route.path.startsWith(item.match || '---')
